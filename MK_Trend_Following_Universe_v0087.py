"""Curated Yahoo Finance instrument universe for MK Trend Following Analytics Engine v0.08.7.
By Murat Konuklar
...
UNIVERSE = {
    ...
    "Crypto Assets": {
        "Major Non-Stable Crypto — USD": [
            # Current market-cap leaders, excluding USD-pegged stablecoins.
            # Yahoo uses a disambiguated symbol for Hyperliquid.
            ("Bitcoin", "BTC-USD"),
            ("Ethereum", "ETH-USD"),
            ("BNB", "BNB-USD"),
            ("XRP", "XRP-USD"),
